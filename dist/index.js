...
var raiseAsync = function raiseAsync(event) {
  ...
  try {
    ...
    var _temp2 = _catch(function () {
      ...
      return Promise.resolve((_events2 = exports.events).emitAsync.apply(_events2, [event].concat(params))).then(function () {});
    }, function (e) {
...
function handle(pattern, handler, priority) {
  ...
  exports.events.on(pattern, handler);
  return function () {
    exports.events.off(pattern, handler);
  };
}
function once(pattern, handler, priority, timeout) {
  ...
  handler.priority = priority;
  exports.events.once(pattern, handler);
...
function raise(event) {
  ...
  try {
    ...
    (_events = exports.events).emit.apply(_events, [event].concat(params));
  } catch (e) {
    if (e instanceof Cancel) {
      return params;
    }
      ...
      switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          handlers.forEach(function (_ref) {
            ...
            exports.events.off(event, handler);
          });
...
function Socket(_ref2) {
  ...
  return /*#__PURE__*/React__default.createElement(Fragment, null, filter(items).map(function (_ref3, index) {
