...
var State = /*#__PURE__*/function () {
  ...
  _proto.useBinding = function useBinding(property, _temp) {
    ...
    var value = useRef(transformIn(withDefault(rawValue, defaultValue)));
  ...
  _proto.useState = function useState(property, defaultValue, target) {
    ...
    var updateValue = React.useMemo(function () {
...
export { Events, Socket, bestOnly, createState, ensureArray, events, handle, lessThan, once, plug, raise, raiseAsync, raiseLater, setEventSource, stopPropagationAndExit, useEvent, useIndex, using };
